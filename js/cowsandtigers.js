...
exports.default = {
    ...
    getTopSideNeighboringsCell: function getTopSideNeighboringsCell(param) {
        ...
        //mapCol
        for (var startCellCol = param.unitSide.angleStart.positionCol; startCellCol <= param.unitSide.angleEnd.positionCol - 1; startCellCol++) {
    ...
    getRighttSideNeighboringsCell: function getRighttSideNeighboringsCell(param) {
        ...
        // mapRow
        for (var startCellRow = param.unitSide.angleStart.positionRow; startCellRow <= param.unitSide.angleEnd.positionRow - 1; startCellRow++) {
