...
exports.default = {
    ...
    getNeighboringsCell: function getNeighboringsCell(step, unit, map) {
        ...
        for (var side = 0; side < unitSides.length; side++) {
            ...
            // mapRow
            for (var startCellRow = unitSides[side].angleStart.positionRow; startCellRow < endCellRow; startCellRow++) {

                //mapCol
                for (var startCellCol = unitSides[side].angleStart.positionCol; startCellCol < endCellCol; startCellCol++) {
